  ...
  return (
    <div className="version-bar header-version-bar">
      <div className="version-status">
        ...
        <b>{published ? `运行 v${published.version_number}` : "尚未发布"}</b>
